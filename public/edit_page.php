...
<div id="main">
	...
	<div id="page">
		...
		<h2>Edit Page</h2>
		<form id="edit_page" action="edit_page.php?page=<?php echo urlencode($current_page["id"]); ?>" method="post">
			<p> 
			...
			<p>
				Content: <br>
				<textarea rows="15" cols="100" name="content" form="edit_page"><?php echo htmlentities($current_page["content"]); ?></textarea>
			</p>
